...
function ARP.Util.RotationToDirection(self,rotation)
...
function ARP.Util.ScreenRealToWorld(self,camPos,camRot,coord)
    local distance = 1000.0
    local camForward = ARP.Util.RotationToDirection(self,camRot);
    ...
    local camRight = ARP.Util.RotationToDirection(self,rotRight) - ARP.Util.RotationToDirection(self,rotLeft);
    local camUp = ARP.Util.RotationToDirection(self,rotUp) - ARP.Util.RotationToDirection(self,rotDown);
